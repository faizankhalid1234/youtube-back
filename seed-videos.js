...
const sampleVideos = [
  {
    ...
    description: "Beautiful mountain landscape with amazing views. Perfect for relaxation and inspiration.",
  ...
  },
  {
    ...
    description: "Watch amazing wildlife in their natural habitat. Educational and entertaining content.",
  ...
  },
  {
    ...
    description: "Learn to cook amazing dishes with easy step-by-step instructions. Perfect for beginners.",
  ...
  },
  {
    ...
    description: "In-depth review of the latest technology gadgets. Honest opinions and detailed analysis.",
...
async function seedVideos() {
  try {
    ...
    if (existingVideos > 0) {
      ...
      console.log('💡 To add more videos, delete existing ones first or modify this script')
    }
